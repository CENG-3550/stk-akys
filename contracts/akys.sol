...
contract akys {
    ...
    function approveSupport(string memory _supportID) public {
    ...
    function approveNeed(string memory _needID) public {
    ...
    function cancelSupport(string memory _supportID) public {
    ...
    function cancelNeed(string memory _needID) public {
